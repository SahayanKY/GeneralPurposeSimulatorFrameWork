...
public class Triangle {
	...
	private void calcurateNormal() {
		//外積から面の法線ベクトルを計算する
		normal[0] = (vertexs[1][1]-vertexs[0][1])*(vertexs[2][2]-vertexs[0][2]) -(vertexs[1][2]-vertexs[0][2])*(vertexs[2][1]-vertexs[0][1]);
		normal[1] = (vertexs[1][2]-vertexs[0][2])*(vertexs[2][0]-vertexs[0][0]) -(vertexs[1][0]-vertexs[0][0])*(vertexs[2][2]-vertexs[0][2]);
		normal[2] = (vertexs[1][0]-vertexs[0][0])*(vertexs[2][1]-vertexs[0][1]) -(vertexs[1][1]-vertexs[0][1])*(vertexs[2][0]-vertexs[0][0]);
